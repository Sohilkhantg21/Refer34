...
if (isset($_GET['setwebhook'])) {
    ...
    if ($url) {
        ...
        echo "<pre>Please provide URL parameter: ?setwebhook&url=YOUR_URL</pre>";
    }
    exit;
}
...
if (isset($_GET['deletewebhook'])) {
    ...
    echo "<pre>Webhook removed: " . htmlspecialchars($result) . "</pre>";
    exit;
}
...
if (php_sapi_name() === 'cli') {
    ...
    echo "<p>Use these endpoints to manage webhook:</p>";
    echo "<ul>";
    echo "<li><a href='?setwebhook&url=" . urlencode((isset($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']) . "'>Set Webhook</a></li>";
    echo "<li><a href='?deletewebhook'>Delete Webhook</a></li>";
    echo "</ul>";
